...
public class PersonalAccountProvisioningFormValidator extends ClassValidator<PersonalAccountProvisioningForm> {

    public PersonalAccountProvisioningFormValidator() {
        super(PersonalAccountProvisioningForm.class);
    }

    @Override
    protected void doValidate(PersonalAccountProvisioningForm form, Errors errors) {
